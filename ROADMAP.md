...
- [x] Jump between notes is smooth
- [x] Auto-jump to file diff once click.
- [x] :ReviewToggle command
- [x] a should also work for visual not just "A" and it should be fast
